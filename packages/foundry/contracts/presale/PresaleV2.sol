    ...
    UUPSUpgradeable
{
    ...
    */
    ...
    function buyWithBnb(
        ...
        (, int256 latestPrice, , uint256 updatedAt, ) = bnbPriceAggregator
            .latestRoundData();
    ...
    */
    function calculateReferralAmount(
        ...
        amountToReferral =
            (amountInUsdtOrBnb * (REFERRAL_BONUS * BPS)) /
            (100 * BPS);
    }
    ...
    */
    ...
    function _buyLogic(
        ...
        _updateReferral(
            _referral,
            asset,
            asset == ASSET.BNB ? msg.value : valueInUsd
        );
        ...
        uint256 releaseOnTGE = (gmgAmount * (presaleInfo.tgePercentage * BPS)) /
            (100 * BPS);
